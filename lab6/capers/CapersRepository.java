...
public class CapersRepository {
    ...
    //      function in Utils
    static final File s = join(CAPERS_FOLDER, "story.txt");
    ...
    public static void writeStory(String text) {
        // TODO
        String str = readContentsAsString(s);
        str += text + "\n";
        writeContents(s, str);
    ...
    public static void makeDog(String name, String breed, int age) throws IOException {
        // TODO
        Dog dogy = new Dog(name, breed, age);
        dogy.saveDog();
        System.out.println(dogy.toString());
    }
